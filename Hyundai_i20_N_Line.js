...
(function() {
    ...
    var sceneURL = params.load ? params.load : '__URL__Hyundai_i20_N_Line.gltf'.replace('__URL__', '');
    if (!sceneURL) {
...
function runCode(app) {
    ...
    $( ".v3d-annotation" ).click(function( event ) {
        console.log("I am clicked",$(this).attr("id"));
        var idref=$(this).attr("id");
        window.parent.showmodelwindow($(this).attr("id"),$(this).children(".v3d-annotation-dialog").text()); 
